...
public class RoteiroPersonalizado {
	private int id;
	...
	public RoteiroPersonalizado(int id, String nome, String destino, Date dataPartida, Date dataRetorno, int quantidadePessoas,
